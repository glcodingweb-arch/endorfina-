...
export default function DeliveryDashboardPage() {
    ...
    return (
        <div className="space-y-8">
            <header>
                <h1 className="text-3xl font-bold">Painel de Entregas</h1>
                <p className="text-muted-foreground">Gerencie as entregas de kits em domicílio por evento.</p>
            </header>
            ...
            {!loading && eventsWithStats.length === 0 && (
                 <Card>
                    <CardContent className="text-center py-16">
                        <h3 className="text-xl font-semibold">Nenhum pedido de entrega</h3>
                            ...
                            <Card key={race.id}>
                                ...
                                <CardFooter>
                                    <Button asChild className="w-full">
                                        <Link href={`/admin/delivery/${race.id}`}>
