    ...
    >
      ...
      <div className="p-6 space-y-4">
        ...
        {timeLeft > 0 ? (
          ...
          >
            <div className="text-lg font-bold text-green-600">Evento começou!</div>
            <div className="text-sm text-muted-foreground">Junte-se agora para participar</div>
          </motion.div>
        )}
        ...
        >
          {timeLeft > 0 ? "Reserve sua vaga" : "Entrar no evento"}
        </motion.button>
      </div>
    </motion.div>
  )
